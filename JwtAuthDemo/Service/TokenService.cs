...
namespace JwtAuthDemo.Service
{
    public class TokenService
    {
        ...
        public string GenerateAccessToken(User user)
        {
            ...
            var expires = DateTime.Now.AddMinutes(Convert.ToDouble(_configuration["JwtSettings:AccessTokenExpiryMinutes"]));
        ...
        public string GenerateRefreshToken(int userId)
        {
            ...
            // set the expiry date for the refresh token
            var expiryDays = Convert.ToInt32(5);
            var expiryDate = DateTime.Now.AddDays(expiryDays);

            // load the user entity so we can set the required `User` property
        ...
        //internal object GenerateRefreshToken()
        //{
